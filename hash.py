...
"""
Author : Azka Ainul Maarij
Sekolah : Smk Pgri 3 RDDK
Versi : 1.0.0
"""
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Version  "+C+":"+W+" 1.0.0"+Y+"                        |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" Azka"+R+"NoXLaw "+W+"PHL"+Y+"                 |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" islahelanggi10@gmail.com"+Y+"                   |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github   "+C+":"+W+" https://github.com/noxlaw"+Y+"           |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 23 - 02 - 2018"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Team     "+C+":"+W+"N45HT, PHL"+Y+"                   |")
	print (Y+" 0{===================================================}0\n")
